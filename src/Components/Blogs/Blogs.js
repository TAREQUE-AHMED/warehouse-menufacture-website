...
const Blogs = () => {
    return (
        <div>
            <div>
                <h1 className='text-red-500 text-bold'>How will you improve the performance of a React Application?</h1>
            ...
            <div>
                <h1 className='text-red-500 text-bold'>What are the different ways to manage a state in a React Application?</h1>
            ...
            <div>
                <h1 className='text-red-500 text-bold'>How does prototypical inheritance work?</h1>
            ...
            <div>
                <h1 className='text-red-500 text-bold'>Why you do not set the state directly in React. </h1>
            ...
            <div>
                <h1 className='text-red-500 text-bold'>What is a unit test? Why should write unit tests?</h1>
